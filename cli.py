...
parser.add_argument('-a', '--animation', dest='animation', help='Run an animation')
...
###
if args.brightness and not args.color:
  sys.exit("-b, --brightness must be set with -c, --color argument")
